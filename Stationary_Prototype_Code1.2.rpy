...
# 5. CHARACTERS
# Standard speaking character - Name is White
define alex = Character("Alex", color="#ffffff")

# Internal Monologue Character
# Name is "Alex" (Same as spoken), but text (what) is italicized and grey.
# This ensures the Name Box appears with "Alex" in it.
define alex_inner = Character("Alex", color="#ffffff", what_italic=True, what_color="#cccccc")

define amyra = Character("Amyra", color="#98fb98") # Light green
define rowan = Character("Rowan", color="#d3d3d3") # Grey
define daniel = Character("Daniel", color="#add8e6") # Blue
define intercom = Character("Intercom Voice", color="#ff6666") # Red/Cold
...
label start:
    ...
    if persistent.loop_count == 0:
        ...
        # Using alex_inner ensures the name "Alex" appears, but text is grey/italic
...
label encounter_rowan:
    ...
    # - Note: This is Alex speaking to Rowan, so we use 'alex'
